...
namespace lokanta
{
    class cOdeme
    {
        ...
        public bool billClose(cOdeme bill)
        {
            ...
            SqlCommand cmd = new SqlCommand("Insert Into hesapOdemeler(ADISYONID,ODEMETURID,MUSTERIID,ARATOPLAM,KDVTUTARI,TOPLAMTUTAR,INDIRIM) values(@ADISYONID,@ODEMETURID,@MUSTERIID,@ARATOPLAM,@KDVTUTARI,@TOPLAMTUTAR,@INDIRIM)", con);
